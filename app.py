...
COLOR_DEMANDA = "#1d4ed8"
COLOR_PROYECCION = "#b45309"
COLOR_INTERVALO = "#64748b"
COLOR_RELLENO_INTERVALO = "rgba(29, 78, 216, 0.12)"
COLOR_TEXTO_GRAFICO = "#172033"
COLOR_GRILLA = "#d8e0ea"
...
app.title = "Dashboard energia - Taller 2"

server = app.server
app.config.suppress_callback_exceptions = True


# Load data from csv and keep the index sorted by time
def load_data():
